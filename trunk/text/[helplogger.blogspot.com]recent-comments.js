var numComments = numComments || 5,
    ...
    bloggerAvatar = bloggerAvatar || "http://1.bp.blogspot.com/-7bkcAKdpGXI/UrbyQRqvSKI/AAAAAAAAFmI/oBv_yMeYnMQ/s1600/blogger.png",
...
function helploggercomments(helplogger) {
    ...
    for (var i = 0; i < numComments; i++) {
        ...
        if (authorAvatar.indexOf("/s1600/") != -1) {
            ...
            authorAvatar = bloggerAvatar + "&s=" + avatarSize
            } else {
                authorAvatar = bloggerAvatar
            }
