...
{jQuery('#'+ptr.id).append('<div class="jGM_back"><a href="#">&laquo; Atrás</a></div>');jQuery('#'+ptr.id+' div.jGM_back').bind('click',function(){if(jQuery.jGlideMenu.animation==true)return false;jQuery.jGlideMenu.scrollToTile((ctr-1),jQuery.jGlideMenu.defaultScrollBackSpeed);return false;});if(jQuery.jGlideMenu.tileCount>2)
...
jQuery.jGlideMenu.imagePath+='/';var template=new String('');template='<div class="jGM_cats"><h4>'+t+'</h4><p class="jGM_desc">'+d+'</p></div>';template+='<div class="jGM_pager"><a href="#" rel="Up" style="display:none"><img src="http://lh3.googleusercontent.com/-5IfcxmYPEHI/T4OCi8dUPZI/AAAAAAAACYE/iahyjH1ncLI/s9/arrow_up.gif" alt="Scroll Up"/></a></div>';template+='<div class="jGM_content">';for(var i=0;i<l.length;i++)
{var hash=(l[i][2]==1)?'':'#';var type=(l[i][2]==1)?'':' class="jGM_more"';template+='<a href="'+hash+l[i][0]+'"'+type+'>'+l[i][1]+'</a>';}
template+='</div>';template+='<div class="jGM_pager"><a href="#" rel="Down"  style="display:none"><img src="http://lh5.googleusercontent.com/-t8RVnCZTOHA/T4OCinyvpQI/AAAAAAAACX4/3WYrxxhMTW0/s9/arrow_dn.gif" alt="Scroll Up"/></a></div>';return template;},errorTrap:function(m)
